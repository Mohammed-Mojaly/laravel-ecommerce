                ...
                <form action="{{ route('customer.update_profile') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center mb-4">
                            ...
                            @else
                                <img src="{{ asset('assets/users/avatar.jpg') }}" alt="{{ auth()->user()->full_name }}" class="img-thumbnail" width="120">
                            @endif
                        </div>
                        ...
                        <div class="col-lg-12 form-group mt-3">
                            <button class="btn btn-dark" id="btn_full_width" type="submit">Update profile</button>
                        </div>
                    </div>
