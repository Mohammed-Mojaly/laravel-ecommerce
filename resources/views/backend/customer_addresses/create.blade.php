...
{{-- <script src="{{ asset('backend/vendors/typeahead/bootstrap3-typeahead.min.js') }}"></script> --}}
<div class="col-sm-12 grid-margin stretch-card">
    <div class="card">
        ...
        <div class="card-header mb-3 py-3 d-flex">
            <h6 class="mt-1 font-weight-bold text-primary">Create Address</h6>
            <div class="ml-auto">
                <a href="{{ route('admin.customer_addresses.index') }}" class="btn btn-inverse-primary btn-fw">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control typehead" name="customer_name" id="customer_name" value="{{ old('customer_name', request()->input('customer_name')) }}" placeholder="Start typing something to search customer..." autocomplete="off">
