...
<div class="col-sm-12 grid-margin stretch-card">
    <div class="card">
        ...
        <div class="card-header mb-3 py-3 d-flex">
            <h6 class="mt-1 font-weight-bold text-primary">Edit Address ({{ $customer_address->address_title }})</h6>
            <div class="ml-auto">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="customer_name" value="{{ $customer_address->user->full_name }}" readonly style="background: #00000057;">
