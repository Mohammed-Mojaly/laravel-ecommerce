        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    <select name="sort_by" class="form-control">
                        ...
                        <option value="name" {{ old('sort_by', request()->input('sort_by')) == 'ref_id' ? 'selected' : '' }}>Name</option>
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    <select name="order_by" class="form-control">
                        <option disabled selected hidden>Ordering</option>
            ...
            <div class="col-lg-2">
                <div class="form-group">
                    <select name="limit_by" class="form-control">
                        <option disabled selected hidden>Per Page</option>
            ...
            <div class="col-lg-1 mt-1">
                <div class="form-group">
                    ...
                    <button type="submit" name="submit" class="btn btn-outline-secondary btn_filter">Filter</button>
                </div>
