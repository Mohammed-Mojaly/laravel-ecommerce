...
@section('content')
    ...
    <div class="card shadow m-4">
        <div class="card-header py-3 d-flex mt-2">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <td>{{ $order->ref_id }}</td>
                            <th>Customer</th>
                            <td><a href="{{ route('admin.customers.edit', $order->user_id) }}">{{ $order->user->full_name }}</a></td>
                        </tr>
                        <tr>
                            <th>Address</th>
                            <td><a href="{{ route('admin.customer_addresses.edit', $order->user_address_id) }}">{{ $order->user_address->address_title }}</a></td>
