    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="card-header mb-3 py-3 d-flex">
            <h6 class="mt-1 font-weight-bold text-primary">Add Customer</h6>
            <div class="ml-auto">
     ...
     <div class="card-body">
        ...
        <form class="forms-sample" action="{{route('admin.customers.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
