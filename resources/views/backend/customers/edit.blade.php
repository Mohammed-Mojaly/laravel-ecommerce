    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="card-header mb-3 py-3 d-flex">
            <h6 class="mt-1 font-weight-bold text-primary">Edit Customer ({{$customer->full_name}})</h6>
            <div class="ml-auto">
                <a href="{{ route('admin.customers.index') }}" class="btn btn-inverse-primary btn-fw">
        ...
        <form class="forms-sample" action="{{route('admin.customers.update' , $customer->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="row">
                <div class="col-sm-3">
