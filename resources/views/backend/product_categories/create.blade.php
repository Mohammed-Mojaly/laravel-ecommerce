    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="card-header mb-3 py-3 d-flex">
            <h6 class="mt-1 font-weight-bold text-primary">Add Category</h6>
            <div class="ml-auto">
                <a href="{{ route('admin.product_categories.index') }}" class="btn btn-inverse-primary btn-fw">
     ...
     <div class="card-body">
        <form class="forms-sample" action="{{route('admin.product_categories.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
