...
<div class="row">
    <div class="col-lg-8">
        ...
        <div class="row">
            ...
            {{-- <div id="MydivChange" onclick="myfun()"> --}}

            <div class="col-6 form-group">

                    <div class="custom-control custom-radio p-md-5 mdiv"
                    {{($customer_address_id) == $address->id ? 'id=MydivStyle' : ''}}
                    data-toggle="modal"
        ...
        @if ($customer_address_id != 0)
            ...
            <div class="row">
                @forelse($shipping_companies as $shipping_company)
                    <div class="col-6 form-group">
                        <div class="custom-control custom-radio p-md-5 mdiv"
                        {{ ($shipping_company_id) == $shipping_company->id ? 'id=MydivStyle' : ''}}
                        data-toggle="modal"
                        data-target="#exampleModalCenter"
                        >
                            <input
                    ...
                    <div class="col-6 form-group">
                        <div class="custom-control custom-radio">
                            ...
                            <label for="payment-method-{{ $payment_method->id }}" class="custom-control-label text-small">
                               <i class="fab fa-{{strtolower($payment_method->name)}}"></i> <b>{{ $payment_method->name }}</b>
                            </label>
                        </div>
                    </div>
                @empty
