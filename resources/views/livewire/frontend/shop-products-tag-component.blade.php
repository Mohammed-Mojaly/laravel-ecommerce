              ...
              <h5 class="text-uppercase mb-4">Categories</h5>
                ...
                @foreach ($shop_categories_menu as $shop_category)
                    ...
                    <div class="py-2 px-4 bg-dark text-white mb-3"><strong class="small text-uppercase font-weight-bold">
                       {{$shop_category->name}} </strong></div>
                       <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                        @forelse($shop_category->apperdchildren as $sub_shop_category)
                        <li class="mb-2">
                ...
                <div class="col-lg-6">
                  <ul class="list-inline d-flex align-items-center justify-content-lg-end mb-0">
                    ...
                    <li class="list-inline-item" wire:ignore>
                      <select class="selectpicker ml-auto" wire:model="sortingBy" name="sorting" data-width="200" data-style="bs-select-form-control" data-title="Default sorting">
              ...
              <div class="row">
                ...
                @forelse ($products as $product)
                    ...
                    <div class="product text-center">
                        ...
                        <div class="badge text-white badge-"></div><a class="d-block" href="{{route('frontend.product' , $product->slug)}}">
                            ...
                            @else
                                <img class="img-fluid w-100" src="{{ asset('assets/products/default_product.jpg')}}" alt="{{$product->name}}">
