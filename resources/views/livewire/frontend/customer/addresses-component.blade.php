<div x-data="{ formShow: @entangle('showForm') }">
    <div class="d-flex custome_head">
        <h2 class="h5 text-uppercase mb-4">Addresses</h2>
        <div class="ml-auto">
            <button type="button" @click="formShow = true" class="btn btn-secondary rounded shadow">
              + Add new address
            </button>
        </div>
    </div>
    ...
    <form wire:submit.prevent="{{ $editMode ? 'update_address' : 'store_address' }}" x-show="formShow" @click.away="formShow = false">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 form-group">
                <button class="btn btn-dark" id="btn_full_width" type="submit">
                ...
                <tr>
                    ...
                    <td class="text-right">
                        <div class="btn-group btn-group-sm">
                            <button type="button" wire:click.prevent="edit_address('{{ $address->id }}')" class="btn btn-success" style="margin-right: 5px;">
