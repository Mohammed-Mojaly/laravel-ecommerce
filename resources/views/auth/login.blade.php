            ...
            <div class="col-6 offset-3">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <button class="btn btn-dark" id="myBtn"  ondblclick="myFunction()" type="submit">{{ __('Login') }}</button>
                                ...
                                @if (Route::has('register'))
                                    <a id="accountlink" class="btn btn-secondary float-right" href="{{ route('register') }}">
