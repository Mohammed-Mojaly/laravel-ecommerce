...
class StateController extends Controller
{
    ...
    public function store(StateRequest $request)
    {
       ...
       return redirect()->route('admin.states.index')->with('success', 'Created successfuly');
    ...
    public function update(StateRequest $request,State $state)
    {
        ...
        return redirect()->route('admin.states.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(State $state)
    {
        ...
        $state->delete();
        return redirect()->route('admin.states.index')->with('success', 'Deleted successfuly');
    }
