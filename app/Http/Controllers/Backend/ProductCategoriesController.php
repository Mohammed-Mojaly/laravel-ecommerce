...
class ProductCategoriesController extends Controller
{
    ...
    public function store(ProductCategoryRequest $request)
    {
       ...
       return redirect()->route('admin.product_categories.index')->with('success', 'Created successfuly');
    ...
    public function update(ProductCategoryRequest $request, ProductCategory $productCategory)
    {
        if(!auth()->user()->ability('admin','update_product_categories')){
            ...
            return redirect()->route('admin.product_categories.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(ProductCategory $productCategory)
    {
        ...
        return redirect()->route('admin.product_categories.index')->with('success', 'Deleted successfuly');
    }
