...
class ProductCouponController extends Controller
{
    ...
    if(!auth()->user()->ability('admin','create_product_coupons')){
       ...
       return redirect()->route('admin.product_coupons.index')->with('success', 'Created successfuly');
    }
    ...
    public function update(ProductCouponRequest $request, ProductCoupon $productCoupon)
    {
        ...
        return redirect()->route('admin.product_coupons.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(ProductCoupon $productCoupon)
    {
        ...
        return redirect()->route('admin.product_coupons.index')->with('success', 'Deleted successfuly');
    }
}
