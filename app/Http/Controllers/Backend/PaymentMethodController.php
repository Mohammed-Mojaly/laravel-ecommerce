...
class PaymentMethodController extends Controller
{
    ...
    public function store(PaymentMethodRequest $request)
    {
        ...
        return redirect()->route('admin.payment_methods.index')->with('success', 'Created successfuly');
    }
    ...
    public function update(PaymentMethodRequest $request, PaymentMethod $payment_method)
    {
        ...
        return redirect()->route('admin.payment_methods.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(PaymentMethod $payment_method)
    {
        ...
        return redirect()->route('admin.payment_methods.index')->with('success', 'Deleted successfuly');
