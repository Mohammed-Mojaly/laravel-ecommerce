...
class ProductReviewController extends Controller
{
    ...
    public function update(ProductReviewRequest $request,ProductReview $productReview)
    {
        ...
        $productReview->update($request->validated());
            ...
            return redirect()->route('admin.product_reviews.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(ProductReview $productReview)
    {
        ...
        return redirect()->route('admin.product_reviews.index')->with('success', 'Deleted successfuly');
    }
}
