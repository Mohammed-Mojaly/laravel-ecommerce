...
class SupervisorController extends Controller
{
    ...
    public function create()
    {
        ...
        $permissions = Permission::distinct()->get(['id' , 'display_name']);
    ...
    public function store(SupervisorRequest $request)
    {
       ...
       return redirect()->route('admin.supervisors.index')->with('success', 'Created successfuly');
    ...
    public function update(SupervisorRequest $request, User $supervisor)
    {
        ...
        if($image = $request->file('user_image')){
            ...
            return redirect()->route('admin.supervisors.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(User $supervisor)
    {
        ...
        $supervisor->delete();
        return redirect()->route('admin.supervisors.index')->with('success', 'Deleted successfuly');
    }
