...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        ...
        if ($request->images && count($request->images) > 0) {
            ...
            foreach ($request->images as $image) {
                ...
                Image::make($image->getRealPath())->resize(600, 600,null, function ($constraint) {
        ...
        return redirect()->route('admin.products.index')->with('success', 'Created successfuly');
    }
    ...
    public function destroy(Product $product)
    {
        ...
        $product->delete();
        return redirect()->route('admin.products.index')->with('success', 'Deleted successfuly');
    }
