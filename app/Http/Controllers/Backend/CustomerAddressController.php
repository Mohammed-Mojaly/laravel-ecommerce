...
class CustomerAddressController extends Controller
{
    ...
    public function store(CustomerAddressRequest $request)
    {
        ...
        return redirect()->route('admin.customer_addresses.index')->with('success', 'Created successfuly');
    }
    ...
    public function update(CustomerAddressRequest $request, UserAddress $customer_address)
    {
        ...
        return redirect()->route('admin.customer_addresses.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(UserAddress $customer_address)
    {
        ...
        return redirect()->route('admin.customer_addresses.index')->with('success', 'Deleted successfuly');
    }
}
