...
class TagController extends Controller
{
    ...
    public function store(TagRequest $request)
    {
       ...
       return redirect()->route('admin.tags.index')->with('success', 'Created successfuly');
    ...
    public function update(TagRequest $request, Tag $tag)
    {
        if(!auth()->user()->ability('admin','update_tags')){
            ...
            $tag->update($input);
            return redirect()->route('admin.tags.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(Tag $tag)
    {
        ...
        $tag->delete();
        return redirect()->route('admin.tags.index')->with('success', 'Deleted successfuly');
    }
}
