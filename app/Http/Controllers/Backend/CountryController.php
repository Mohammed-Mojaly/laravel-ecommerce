...
class CountryController extends Controller
{
    ...
    public function store(CountryRequest $request)
    {
       ...
       return redirect()->route('admin.countries.index')->with('success', 'Created successfuly');
    ...
    public function update(CountryRequest $request,Country $country)
    {
        ...
        return redirect()->route('admin.countries.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(Country $country)
    {
        ...
        $country->delete();
        return redirect()->route('admin.countries.index')->with('success', 'Deleted successfuly');
    }
