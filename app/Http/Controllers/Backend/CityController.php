...
class CityController extends Controller
{
    ...
    public function store(CityRequest $request)
    {
        ...
        return redirect()->route('admin.cities.index')->with('success', 'Created successfuly');
    }
    ...
    public function update(CityRequest $request, City $city)
    {
        ...
        return redirect()->route('admin.cities.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(City $city)
    {
        ...
        $city->delete();
        return redirect()->route('admin.cities.index')->with('success', 'Deleted successfuly');
    }
