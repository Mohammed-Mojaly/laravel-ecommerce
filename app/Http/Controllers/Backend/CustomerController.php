...
class CustomerController extends Controller
{
    ...
    public function store(CustomerRequest $request)
    {
       ...
       return redirect()->route('admin.customers.index')->with('success', 'Created successfuly');
    ...
    public function update(CustomerRequest $request, User $customer)
    {
        ...
        if($image = $request->file('user_image')){
            ...
            return redirect()->route('admin.customers.index')->with('success', 'Updated successfuly');
    }
    ...
    public function destroy(User $customer)
    {
        ...
        $customer->delete();
        return redirect()->route('admin.customers.index')->with('success', 'Deleted successfuly');
    }
