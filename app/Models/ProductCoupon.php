...
class ProductCoupon extends Model
{
    ...
    protected function checkDate()
    {
        if($this->expire_date != '' )
        {
            return (Carbon::now()->between($this->start_date, $this->expire_date, true)) ? true : false;
        }
        else
        {
            return true;
    ...
    protected function checkUsedTimes()
    {
        if($this->use_times != '')
        {
            return ($this->use_times > $this->used_times ) ? true : false;
        }
        else
        {
            return true;
    ...
    protected function checkGreaterThan($total)
    {
        ...
        {
            return ($this->greater_than >= $total) ? true : false;
        }
        else
        {
            return true;
